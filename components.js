...
var components = exports.components = {
	...
	tourpoll: function (target, room, user) {
		if (!this.can('poll', null, room)) return false;
		this.parse('/poll Tournament format?, ou, ubers, uu, ru, nu, lc, vgc, monotype, [gen 4] ou, random, 1v1 random, uber random, high tier random, low tier random, lc random, monotype random, generational random, inverse random, community random, spring random, orb random, hoenn random, hoenn weather random, super smash bros. random, winter wonderland, furry random, metronome 3v3 random, metronome 6v6 random, doubles random, triples random, battle factory, challenge cup, [seasonal] random, [gen 2] random, [gen 1] random');
	},
	...
	randompoll: function (target, room, user) {
		if (!this.can('poll', null, room)) return false;
		this.parse('/poll Tournament format?, random, 1v1 random, uber random, high tier random, low tier random, lc random, monotype random, generational random, inverse random, community random, spring random, orb random, hoenn random, hoenn weather random, super smash bros. random, winter wonderland, furry random, doubles random, triples random, battle factory, challenge cup, [seasonal] random, [gen 2] random, [gen 1] random');
	},
